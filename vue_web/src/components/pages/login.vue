<template>
    <div class="loginDivClass">
      <el-card shadow="always" style="top:50px;margin: 0 auto;width: 39%;min-height: 650px;position: relative;">
        ...
        <el-row type="flex" class="row-bg" justify="center" style="top: 60px;">
          <el-col :span="24">
            <h6 style="text-align: center;color: #757575;">东北林业大学农产品预售系统 版权所有</h6>
