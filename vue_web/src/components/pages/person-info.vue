  ...
  <div class="personInfo" id="personInfoId">
    ...
    <el-card shadow="always">
      <el-form label-position="top" label-width="80px" :model="formLabelAlign" :rules="rules" ref="formLabelAlign">
        ...
        <el-row>
          <el-col :span="9" :offset="2">
            <el-form-item label="余额" style="margin-left: 10px">
              <el-input v-model="formLabelAlign.money" disabled style="width: 200px"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
  ...
  export default {
    ...
    mounted() {
      ...
      $.get("http://localhost:8083/user/getInfo.do",jsonObj,function (data) {
        ...
        self.formLabelAlign.status = data.status;
        self.formLabelAlign.email = data.email;
        self.formLabelAlign.address = data.address;
        self.formLabelAlign.money = data.money;
      },"json");
    },
    methods:{
      // submitForm(){
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            if (this.formLabelAlign.sex ==="女"){
              this.formLabelAlign.sex = 0;
            } else {
              this.formLabelAlign.sex = 1;
            }
            console.log("sex:"+this.formLabelAlign.sex);
