  ...
  <div class="index-body">
    <el-row :gutter="20" style="margin-top: 30px;">
      <el-col :span="24">
        ...
        <p class="index-body-p-1">热门农产品</p>
        <hr />
            ...
            <el-card :body-style="{ padding: '0px', textAlign: 'center'}">
              ...
              <div style="padding: 10px;">
                ...
                <div class="bottom clearfix">
                  <el-button type="text" class="button" @click="goGoodsDetail(obj2.goodsId)">查看详情</el-button>
                </div>
              </div>
            </el-card>
          </el-col>
...
<!--            限定每页 12 条数据-->
        ...
        <p class="index-body-p-1" style="margin-top: 60px;">现货农产品</p>
        <hr />
        ...
        <!--<p class="index-body-p-1" style="margin-top: 60px;">预售农产品</p>-->
        <!--<hr />-->
      ...
      data(){
        return{
          items: {
            ...
            img2: require("../../assets/nefu1.jpg"),
            img3: require("../../assets/nefu4.jpg"),
            img4: require("../../assets/nefu3.jpg"),
            img5: require("../../assets/nefu2.jpg")
          },
          rules: {
            search: [
