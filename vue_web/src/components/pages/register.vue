  ...
  <div class="registerDivClass">
    <el-card shadow="always" style="top:50px;margin: 0 auto;width: 29%;min-height: 650px;position: relative;">
      <div style="text-align:center;margin-top: 30px;">
        <img src="../../assets/nefu.jpg" alt="logoImg" style="max-width: 90px;">
      ...
      <div style="text-align: center;margin-left: 20px;margin-top: 50px;">
        ...
        <el-input placeholder="请输入住址，最多 50 位" v-model="inputaddress" clearable maxlength="50"
                  show-word-limit style="margin-top: 30px;">
          <template slot="prepend"><span style="padding-left: 7.2px;padding-right: 7.2px;">住址：</span></template>
        </el-input>
      </div>
      ...
      <el-row type="flex" class="row-bg" justify="center" style="top: 10px;">
        <el-col :span="24">
          <h6 style="text-align: center;color: #757575;">东北林业大学农产品交易系统 版权所有</h6>
  ...
  export default {
    ...
    methods:{
      login() {
        ...
        jsonObj.address = this.inputaddress;
